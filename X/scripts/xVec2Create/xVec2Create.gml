...
/// @desc Creates a new vector with given components. If only the
///       first value is supplied, then it is used for every
///       component.
...
xAssert(false, "Trying to construct a 2D vector with " + string(argument_count) + " components!");