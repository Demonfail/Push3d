...
/// @param {real} button The mouse button that was down during the mouse movement.
...
/// @param {bool} ctrl   True if the ctrl key was held during the mouse movement.
/// @param {bool} shift  True if the shift key was held during the mouse movement.
