//> Size of the noise texture. Must be the same value as in the p3dSsaoInit script!
#define P3D_SSAO_NOISE_TEXTURE_SIZE 4
...
void main()
{
	...
	float size   = float(P3D_SSAO_NOISE_TEXTURE_SIZE);
